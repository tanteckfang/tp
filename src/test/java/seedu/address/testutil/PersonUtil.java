...
public class PersonUtil {
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        if (descriptor.getCourseChanges().isPresent()) {
            List<CourseChange> courseChanges = descriptor.getCourseChanges().get();
            if (courseChanges.isEmpty()) {
                sb.append(PREFIX_COURSE);
            } else {
                courseChanges.forEach(s -> sb.append(PREFIX_COURSE).append(s.getCourseChangeDescription()).append(" "));
            }
        }
        return sb.toString();
    }
